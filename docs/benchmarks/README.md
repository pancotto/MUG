...
```bash
python benchmarks/benchmark_release.py --version v1.4.0
```

The script writes:

- `docs/benchmarks/v1.4.0_benchmark.md`
- `docs/benchmarks/runs/v1.4.0.json`
...
```bash
python benchmarks/benchmark_release.py --version v1.4.0 --keep-artifacts
```
